...
LANG_TEXTS = {
    'cs': {
        ...
        'services_subtitle': 'Od klasické švédské po lymfatickou a aromaterapii — vyberte masáž, která vám přinese úlevu.',
        'service_detail': 'Detail masáže',
        'all_massages': 'Všechny masáže',
        'team_label': 'Náš tým',
        'team_title': 'Certifikované masérky',
    ...
    'en': {
        ...
        'hero_subtitle': 'Certified masseuses, private cabins and a luxurious atmosphere in the heart of Prague. Give yourself the peace and regeneration you deserve.',
        ...
        'services_subtitle': 'From classic Swedish to lymphatic and aromatherapy — choose the massage that brings you relief.',
        'service_detail': 'Massage details',
        'all_massages': 'All massages',
        'team_label': 'Our team',
        'team_title': 'Certified masseuses',
    ...
    'ru': {
        ...
        'hero_subtitle': 'Сертифицированные массажистки, приватные кабинеты и роскошная атмосфера в сердце Праги. Подарите себе покой и восстановление, которое вы заслуживаете.',
        ...
        'services_subtitle': 'От классического шведского до лимфодренажного и ароматерапии — выберите массаж, который принесёт вам облегчение.',
        'service_detail': 'Подробнее о массаже',
        'all_massages': 'Все массажи',
        'team_label': 'Наша команда',
        'team_title': 'Сертифицированные массажистки',
...
SERVICES = {
    'cs': [
        {
            'slug': 'klasicka-masaz', 'title': 'Klasická masáž',
            'desc': 'Tradiční švédská masáž pro uvolnění svalového napětí a celkovou relaxaci celého těla pomocí hladivých a hnětacích hmatů.',
            'duration': '60 min', 'price': '1&nbsp;200 Kč',
            'img': '/assets/img/services/klasicka-masaz.webp',
            'alt': 'Klasická masáž Praha — Black Diamond Spa',
        },
        {
            'slug': 'cbd-relaxacni-masaz', 'title': 'Relax masáž',
            'desc': 'Jemná relaxační masáž s prémiálními oleji pro hluboké uvolnění těla i mysli.',
            'duration': '75 min', 'price': '1&nbsp;700 Kč',
            'img': '/assets/img/services/cbd-relaxacni-masaz.webp',
            'alt': 'Relax masáž Praha — Black Diamond Spa',
        },
        {
            'slug': 'aromaterapie', 'title': 'Aromamasáž',
            'desc': 'Aromamasáž s prémiálními éterickými oleji pro hlubokou relaxaci těla i mysli.',
            'duration': '75 min', 'price': '1&nbsp;400 Kč',
            'img': '/assets/img/services/aromaterapie.webp',
            'alt': 'Aromamasáž Praha — Black Diamond Spa',
        },
    ],
    'en': [
        {
            'slug': 'klasicka-masaz', 'title': 'Classic massage',
            'desc': 'Traditional Swedish massage to release muscle tension and relax the whole body with flowing and kneading strokes.',
            'duration': '60 min', 'price': '1&nbsp;200 CZK',
            'img': '/assets/img/services/klasicka-masaz.webp',
            'alt': 'Classic massage Prague — Black Diamond Spa',
        },
        {
            'slug': 'cbd-relaxacni-masaz', 'title': 'Relax massage',
            'desc': 'Gentle relaxation massage with premium oils for deep release of body and mind.',
            'duration': '75 min', 'price': '1&nbsp;700 CZK',
            'img': '/assets/img/services/cbd-relaxacni-masaz.webp',
            'alt': 'Relax massage Prague — Black Diamond Spa',
        },
        {
            'slug': 'aromaterapie', 'title': 'Aroma massage',
            'desc': 'Aroma massage with premium essential oils for deep relaxation of body and mind.',
            'duration': '75 min', 'price': '1&nbsp;400 CZK',
            'img': '/assets/img/services/aromaterapie.webp',
            'alt': 'Aroma massage Prague — Black Diamond Spa',
        },
    ],
    'ru': [
        {
            'slug': 'klasicka-masaz', 'title': 'Классический массаж',
            'desc': 'Традиционный шведский массаж для снятия мышечного напряжения и общего расслабления тела.',
            'duration': '60 мин', 'price': '1&nbsp;200 CZK',
            'img': '/assets/img/services/klasicka-masaz.webp',
            'alt': 'Классический массаж Прага — Black Diamond Spa',
        },
        {
            'slug': 'cbd-relaxacni-masaz', 'title': 'Релакс массаж',
            'desc': 'Мягкий релакс-массаж с премиальными маслами для глубокого расслабления тела и разума.',
            'duration': '75 мин', 'price': '1&nbsp;700 CZK',
            'img': '/assets/img/services/cbd-relaxacni-masaz.webp',
            'alt': 'Релакс массаж Прага — Black Diamond Spa',
        },
        {
            'slug': 'aromaterapie', 'title': 'Аромамассаж',
            'desc': 'Аромамассаж с премиальными эфирными маслами для глубокого расслабления.',
            'duration': '75 мин', 'price': '1&nbsp;400 CZK',
            'img': '/assets/img/services/aromaterapie.webp',
            'alt': 'Аромамассаж Прага — Black Diamond Spa',
        },
    ],
}
    ...
    'cs': [
        {
            ...
            'bio': 'Julia je certifikovaná masérka specializující se na klasickou a relax masáž. Přizpůsobuje každé sezení potřebám klienta a navozuje hlubokou relaxaci.',
    ...
    'en': [
        {
            ...
            'bio': 'Julia is a certified masseuse specializing in classic and relax massage, tailoring each session to client needs.',
    ...
    'ru': [
        {
            ...
            'bio': 'Julia — сертифицированная массажистка, специализирующаяся на классическом и релакс-массаже.',
