...
T = {
    'cs': {
        ...
        'hero_title':     'Umění<br><em>relaxace</em>',
    ...
    'en': {
        ...
        'hero_title':     'The art of<br><em>relaxation</em>',
    ...
    'ru': {
        ...
        'hero_title':     'Искусство<br><em>расслабления</em>',
...
def build_main(lang):
    ...
    <section class="hero2" aria-label="Úvodní sekce">
      <div class="hero2__bg" aria-hidden="true">
        <img src="/assets/img/hero-spa.webp" alt="" width="1536" height="1024" fetchpriority="high" decoding="async">
      </div>
