...
_BTN_STYLE = (
    "background:#0ABAB5;color:#fff;border:none;border-radius:6px;"
        ...
        if value:
            ...
            try:
                ...
                thumb_html = format_html(
                    ...
                    'border-radius:6px;border:2px solid #0ABAB5">'
                    '</div>',
        ...
        if selected_ids:
            ...
            thumbs = "".join(
                format_html(
                    ...
                    'border-radius:6px;border:2px solid #00827F">'
...
(function () {
  ...
  window.cldPickerCallback = function (items, single) {
    ...
    if (single) {
      ...
      img.style.cssText = 'height:80px;width:64px;object-fit:cover;border-radius:6px;border:2px solid #0ABAB5';
      thumb.innerHTML = '';
    ...
    items.forEach(function (item) {
      ...
      if (strip && !strip.querySelector('[data-id="' + item.id + '"]')) {
        ...
        var img = document.createElement('img');
        img.src = item.thumb;
        img.style.cssText = 'height:72px;width:58px;object-fit:cover;border-radius:6px;border:2px solid #00827F';
