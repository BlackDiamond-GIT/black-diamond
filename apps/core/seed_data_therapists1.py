...
THERAPISTS_PART1 = [
    {
        ...
        'bio_ru': (
            ...
            'и психическое здоровье. В салоне в Nové Město использует премиальные масла в приватном кабинете. '
    ...
    },
    {
        ...
        'bio_cs': (
            ...
            'na Opletalově. Její přístup je klidný, citlivý a zaměřený na hluboký odpočinek těla i mysli. '
        ...
        'bio_en': (
            ...
            'Spa on Opletalova 1566/30. Her approach is calm, sensitive and focused on deep rest for body and mind. '
        ...
        'bio_ru': (
            ...
            'в Black Diamond Spa на Opletalova 1566/30. Её подход спокойный, чуткий и направлен на глубокий '
            ...
            'Работает в приватном кабинете салона в Nové Město с премиальными продуктами. Идеальный выбор '
    ...
    },
    {
        ...
        'bio_cs': (
            ...
            'harmonii těla a mysli prostřednictvím éterických olejů v Black Diamond Spa na Opletalově. '
        ...
        'bio_en': (
            ...
            'body and mind harmony through essential oils at Black Diamond Spa on Opletalova 1566/30. Her sessions '
        ...
        'bio_ru': (
            ...
            'гармонию тела и разума через эфирные масла в Black Diamond Spa на Opletalova 1566/30. Её сеансы '
            ...
            'Клиенты рекомендуют за конфиденциальную атмосферу салона в Nové Město. Запись онлайн в расписании.'
        ),
